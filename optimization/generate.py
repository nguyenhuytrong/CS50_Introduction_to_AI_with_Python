...
class CrosswordCreator():
        ...
        if overlap is not None:
            ...
            for value in self.domains[x].copy():
                ...
                for y_value in self.domains[y]:
                    if value != y_value and value[overlap[0]] == y_value[overlap[1]]:
                        consistent = True
                if not consistent:
    ...
    def ac3(self, arcs=None):
        ...
        if arcs is None:
            arcs = [(var1, var2) for var1 in self.crossword.variables
        ...
        while queue:
            ...
            if self.revise(var1, var2):
                if len(self.domains[var1]) == 0:
                    return False
                for var in self.crossword.neighbors(var1) - {var2}:
